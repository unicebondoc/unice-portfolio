...
export const MEMORIES = [
  ...
  // ─── 4. PROOF — GOLD HERO ───────────────────────────────────────────────
  {
    ...
    isPrimary: true,
    description:
      'My Master\'s capstone wasn\'t a classroom exercise. I ran empirical A/B tests comparing AI-generated vs human-written content on a live Shopify platform — AI content drove 165% more page views and 82% longer time on page, while human content generated 2× higher purchase intent. Measured with Python (pandas, numpy, matplotlib). Awarded 88/100. High Distinction. Western Sydney University.',
