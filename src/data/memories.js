...
export const MEMORIES = [
  // 1 — ORIGIN
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/01-orb-origin.mp4',
  ...
  // 2 — VOICE (The Writer — intimate, slightly smaller)
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/02-orb-writer.mp4',
  ...
  // 3 — PRESSURE
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/03-orb-pressure.mp4',
  ...
  // 4 — REINVENTION
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/04-orb-reinvention.mp4',
  ...
  // 5 — BUILDING
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/05-orb-building.mp4',
  ...
  // 6 — PROOF (gold, prominent — second largest)
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/06-orb-proof.mp4',
  ...
  // 7 — THE WORK (Core Memories, no links)
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/07-orb-work.mp4',
  ...
  // 8 — BECOMING (present — slightly larger)
  {
    ...
    skills: [],
    link: '',
    videoSrc: '/memories/videos/08-orb-becoming.mp4',
  ...
  // 9 — ROOT (identity — largest, base of tree)
  {
    ...
    videoSrc: '/memories/videos/09-orb-root.mp4',
