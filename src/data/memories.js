...
export const MEMORIES = [
  ...
  // foundation → transition → technical growth → shipped work → current direction
  {
    ...
    isPrimary: true,
    description:
      'Studied AB Broadcasting at Bicol University, Philippines. Built a foundation in storytelling, communication, and media production that still shapes how I approach product and AI work today.',
  ...
  },
  {
    ...
    isPrimary: true,
    description:
      'Worked across BDO Unibank and RCBC in client-facing and operations roles. Managed 100+ SME accounts. Built structure, accountability, and stakeholder discipline — then realized I wanted to build, not maintain.',
    tags: ['Banking', 'BDO Unibank', 'RCBC', 'Philippines', 'Operations', 'Finance'],
    skills: [],
    link: '',
    isFuture: false,
    isPrimary: true,
  ...
  // ── Skills / tech stack orb — recruiters can click for arsenal at a glance ───
  {
    ...
    isPrimary: true,
    description:
      'React 18, Three.js, Python, Node.js, OpenAI API, Voiceflow, and the rest of the stack. I use tools to ship systems, not collect buzzwords.',
    tags: ['React 18', 'Three.js', 'Python', 'Node.js', 'OpenAI API', 'Voiceflow', 'RAG', 'Git'],
    skills: ['React 18', 'Three.js', 'Python', 'Node.js', 'OpenAI API', 'Voiceflow', 'RAG', 'Git', 'MongoDB', 'REST APIs'],
    link: '',
    isFuture: false,
    isPrimary: false,
  },
  {
    ...
    isPrimary: true,
    description:
      'Designed and built this entire 3D interactive portfolio — React 18, Three.js, GLSL shaders, and an AI chatbot. Every orb, every particle, every tendril. Sole Technical Project Lead, end-to-end.',
    tags: ['React 18', 'Three.js', 'GLSL', 'OpenAI API', 'React Three Fiber'],
    skills: ['React 18', 'Three.js', 'GLSL', 'OpenAI API', 'React Three Fiber'],
    link: '',
    isFuture: false,
    isPrimary: true,
  },
