...
export const MEMORIES = [
  ...
  // ─── 4. PROOF — GOLD HERO ───────────────────────────────────────────────
  {
    ...
    subtitle: 'LLM RESEARCH · WSU CAPSTONE · 2025',
    year: '2025',
    emotion: 'Pride',
    icon: '🎓',
    category: 'masters',
    ...
    isPrimary: true,
    description:
      'My Master of ICT capstone compared AI-generated and human-written content in a commerce setting. I worked with Python and data analysis to examine the difference between engaging content and useful outcomes. It shaped a habit I bring to every build: test the result, not just the idea.',
    tags: ['WSU', 'Master of ICT', 'LLM Research', 'A/B Testing', 'Python', 'Shopify', 'pandas', 'numpy', 'matplotlib'],
    skills: [],
    link: '',
  ...
  // ─── 5. AI ENGINEER — BLUE ──────────────────────────────────────────────
  {
    ...
    subtitle: 'WHAT WAS DRAWN · FLATSYNC · CORE MEMORIES',
    year: '2024',
    emotion: 'Real Impact',
    icon: '🛠️',
    ...
    isPrimary: true,
    description:
      'What Was Drawn combines hand tracking with retrieval-augmented AI. FlatSync brings chores, shopping and household costs together in an app currently in testing. Core Memories turns a portfolio into somewhere you can explore. My work also spans UNIKRE commerce and operations, a private Mac-hosted automation system, and a Developer / Programmer role in the 10-person CauseConnect ACS internship team. Across the work, I shape the idea, design the interaction, write the software, and work through the details that make it usable.',
    tags: ['GPT-4', 'OpenAI API', 'What Was Drawn', 'FlatSync', 'UNIKRE', 'Ninja Clan', 'Hermes', 'RAG', 'AI Agent', 'Solo Delivery'],
    skills: [],
    link: '',
  ...
  // ─── 6. BECOMING — SOFT PURPLE ──────────────────────────────────────────
  {
    ...
    subtitle: 'ONQST · FOUNDER & BUILDER · 2026',
    year: '2026',
    emotion: 'Ambition',
    icon: '🚀',
    category: 'present',
    ...
    isPrimary: true,
    description:
      'I am building ONQST: an independent business creating AI products, software, and interactive experiences. I care about both sides of the work—something people enjoy using, and something that makes sense as a business. Alongside my Professional Year in Sydney, I am open to product engineering roles, collaborations, and conversations with people building something interesting.',
    tags: ['ONQST', 'Founder', 'Professional Year', 'Product Engineering', 'Open to Work', 'AI Engineer', 'Sydney', '2026'],
    skills: [],
    link: '',
  ...
  // ─── ROOT — IDENTITY (bottom centre) ────────────────────────────────────
  {
    ...
    isRoot: true,
    title: 'Unice Bondoc',
    subtitle: 'FOUNDER & BUILDER · ONQST · FROM MANILA TO SYDNEY',
    year: 'NOW',
    emotion: 'Identity',
    icon: '✦',
    category: 'identity',
