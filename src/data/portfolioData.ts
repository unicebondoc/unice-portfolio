export const PORTFOLIO_DATA = {
  ...
  story: [
    ...
    },
    {
      title: "The Leap",
      years: "2023",
      description: "Moved to Sydney. Enrolled in Master of ICT at Western Sydney University. Shifted fully into technology and AI engineering.",
    },
    {
      title: "The Builder",
      years: "2023–present",
      description: "AI engineering, software projects, technical project delivery, creative digital experiences. Currently in Professional Year (ICT) program in Sydney.",
    },
  ],
