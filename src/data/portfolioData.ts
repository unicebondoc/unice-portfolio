export const PORTFOLIO_DATA = {
  identity: {
    ...
    currentStatus: "Unice has already graduated with a Master of ICT from Western Sydney University, earning a High Distinction for her LLM research. She is currently in her Professional Year (ICT) in Sydney, building AI-focused projects, refining this portfolio, and pursuing the right AI Engineer or Technical Project Lead role. The study chapter is complete. The builder chapter is very much alive.",
  },
  ...
  story: [
    {
      ...
      years: "2012–2016",
      description: "Bachelor of Communication (Broadcasting) at Bicol University, Philippines. Foundation in storytelling, media, and communication.",
    },
    {
      title: "The Corporate Arc",
      years: "2018–2022",
      description: "Banking and financial services in the Philippines — BDO Unibank (1 year) and RCBC (3 years). Client management, compliance, stakeholder coordination. Managed 100+ concurrent SME accounts at RCBC.",
    },
    {
      title: "The Leap",
      years: "2023",
      description: "Moved to Sydney. Began her Master of ICT at Western Sydney University. Shifted fully into technology and AI engineering.",
    },
    {
      title: "The Builder",
      years: "2023–present",
      description: "Graduated with Master of ICT from Western Sydney University. Now in Professional Year (ICT) in Sydney — building AI-focused projects, refining this portfolio, and pursuing the right AI Engineer or Technical Project Lead role.",
    },
  ],
  ...
  skills: {
    projectAndDelivery: [
      ...
      "Stakeholder Coordination", "Client Account Management",
      "Requirements Gathering", "Risk Management",
      "Jira", "Trello", "Confluence", "Notion", "ClickUp",
      "Microsoft Teams", "Slack",
    ],
    programmingAndDevelopment: [
      "Python", "JavaScript", "HTML5", "CSS3", "SQL",
      "React 18", "Node.js", "REST APIs", "Git", "GitHub",
    ],
    aiAndGenerativeAI: [
    ...
    platformsAndTools: [
      "Shopify Liquid", "Flutter", "MongoDB",
      "Figma", "VS Code",
      "Adobe Premiere Pro", "Photoshop", "Lightroom",
      "Microsoft 365",
    ],
    developingAndFamiliar: [
      "FastAPI", "Three.js", "React Three Fiber",
      "GLSL Shaders", "Azure OpenAI", "Azure AI Services",
      "Hugging Face", "AWS Cloud",
    ],
  },
