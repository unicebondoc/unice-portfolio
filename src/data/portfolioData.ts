  ...
  projects: [
    {
      ...
      highlights: [
        ...
        "Architected multi-workflow pipelines in n8n with Supabase (PostgreSQL) as data layer; integrated OpenAI for dynamic message generation.",
    ...
    },
    {
      ...
      role: "Sole Developer",
      description: "Full-stack gesture-controlled oracle card web app. Users draw cards using real-time hand tracking via webcam — no clicks required. AI generates personalised readings through a full RAG pipeline. 0% error rate in production since launch.",
      ...
      highlights: [
        ...
        "Per-IP rate limiting and Ko-fi reading-limit monetisation. 0% error rate in production since launch.",
      ],
    },
    {
      ...
      role: "Sole Developer",
      description: "Conversational AI personal assistant on Telegram using OpenClaw as the agent framework — natural-language task management, diary entries, calendar reminders, daily briefings, weather lookups, web search, and GitHub queries. Deployed on a self-hosted Linux server (Zorin OS) at $0/month, running continuously via systemd since March 2026. Benchmarked MiniMax Text 2.7 against Qwen 2.5 and GPT-4o-mini — MiniMax selected for superior speed and cost efficiency. Persistent memory via OpenClaw's native backend.",
      ...
      highlights: [
        ...
        "Persistent memory managed via OpenClaw's native backend. Running as a systemd service on self-hosted Zorin OS Linux server at $0/month.",
      ],
    },
    {
