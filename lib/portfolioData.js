...
export const PORTFOLIO_DATA = {
  ...
  story: [
    ...
    { title: 'The Leap', years: '2023', description: 'Moved to Sydney. Began her Master of ICT at Western Sydney University. Shifted fully into technology and AI engineering.' },
    { title: 'The Builder', years: '2023–present', description: 'Graduated with Master of ICT from Western Sydney University. Now in Professional Year (ICT) in Sydney — building AI-focused projects, refining this portfolio, and pursuing the right AI Engineer or Technical Project Lead role.' },
  ],
